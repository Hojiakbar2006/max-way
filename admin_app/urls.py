...
urlpatterns = [
    ...
    path('product/list/', product_list, name='product'),
    path('order/list/', order_list, name='order'),
    path('users/list/', users_list, name='order'),
    path('category/list/', category_list, name='order'),
